...
//				"anonymous", "adf", "centos");
		List<String> files = listFtpFilesInDir("ftp://111.231.81.206:21",
				"ftpadmin", "ftp", "develop");
		for (String file : files) {
			System.out.println(file);
		}

		File file = new File("d://ftptest//3.txt");
		putFileToFtp("ftp://111.231.81.206:21","ftpadmin","ftp","develop","4.txt",file);
	}
